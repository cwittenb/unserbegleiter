...
**Prozessreflexion** *(Messmodell seit S107 — Begründung: `docs/designnotiz-beziehungswesen.md`)*: Jede Person gibt im eigenen Raum verdeckt ab, wie es dem **Beziehungswesen** geht (»angenommen, eure Beziehung wäre ein eigenständiges Wesen mit eigenen Bedürfnissen und Gefühlen — wie ergeht es ihm?«), dazu je aktivem gemeinsamen Auftrag **Passung** (trifft das Thema den Entwicklungsfokus?) und **Wirksamkeit** (wie wirksam erlebe ich mich dabei?). Sind beide Beiträge da, ist die Runde bereit; aufgedeckt wird ausschließlich im gemeinsamen Moment, häppchenweise und **in Worten statt in Zahlen**.

Beide beantworten **dieselbe Frage über dasselbe Dritte**. Damit gibt es keinen wahren Wert und niemanden, der falsch liegt: Ein Abstand zwischen den Sichten ist ein Beziehungs-Befund (kein Fehler, kein Mittelwert) und die **reichere Tür** — dass zwei dasselbe verschieden erleben können, ohne dass es eine Bedrohung ist, vertieft mehr als Übereinstimmung. Hohe Passung bei niedriger Wirksamkeit ist die Stelle, an der Begleitung trägt; niedrige Passung ist eine Einladung, den Auftrag neu zu verhandeln.

*Bis S107 wurden stattdessen Nähe-Wert und Zweitschätzung erhoben; ihre Differenz galt als »Lese-Genauigkeit« und Empathie-Signal. Verworfen, weil das ein Ziel impliziert (richtig liegen), das dem eigentlichen Vorgang (Perspektive einnehmen) äußerlich ist — der Zweck der Frage ist erfüllt, bevor die Antwort da ist. Ein Empathie-Auftrag bleibt möglich, aber nur als **Selbstverpflichtung**, die eine Person sich gibt; das System schlägt ihn nie vor.*
