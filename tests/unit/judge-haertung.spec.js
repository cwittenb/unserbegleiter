...
describe("Judge-Prompt-Härtung (j4)", () => {
  it("Version ist aktuell (j8 · S103: Urteils-Konsistenz)", () => {
    expect(JUDGE_PROMPT_VERSION).toBe("j8");   // S103: Urteils-Konsistenz; S86: Beleg-Stil; S85: Reinform-Zeile; S76: Strukturausgabe
  });
