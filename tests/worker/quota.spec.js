...
beforeAll(async () => {
  ...
  mf = new Miniflare({
    ...
    bindings: { ADMIN_TOKEN: ADMIN, QUOTA_LIMIT: "5", QUOTA_FENSTER_TAGE: "3", QUOTA_KARENZ: "2", RATE_PRO_MINUTE: "50", DUPLIKAT_SCHWELLE: "3", LLM_PROVIDER: "anthropic", ANTHROPIC_API_KEY: "test-key", ANTHROPIC_MODEL: "test-modell" },
    serviceBindings: {
      async UPSTREAM() {
        upstreamCalls++;
...
describe("Raten-Limit je Minute", () => {
  it("oberhalb der Minutenrate ⇒ 429 mit Durchatmen-Meldung", async () => {
    ...
    const mf2 = new Miniflare({
      ...
      compatibilityDate: "2026-06-01",
      bindings: { ADMIN_TOKEN: ADMIN, RATE_PRO_MINUTE: "2", QUOTA_LIMIT: "50", LLM_PROVIDER: "anthropic", ANTHROPIC_API_KEY: "test-key", ANTHROPIC_MODEL: "test-modell" },
